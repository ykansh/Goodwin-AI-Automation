      ...
      <form onSubmit={handleConfirm} className="flex-1 min-h-0 flex flex-col">
            ...
            <div className="bg-white dark:bg-[#1a1d1a] border border-gray-200 dark:border-[#2d302d] rounded-md p-5 sm:p-6 shadow-xs space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
                {LOST_REASONS.map((r) => (
                  <label
                    key={r}
                    className={`flex items-center gap-3 p-3.5 rounded-md border text-sm font-bold cursor-pointer transition-all ${
                      reason === r
        ...
        <div className="shrink-0 bg-white dark:bg-[#1a1d1a] border-t border-gray-200 dark:border-[#2d302d] px-4 sm:px-6 lg:px-8 py-3.5 shadow-sm z-10">
          <div className="w-full max-w-[1200px] mx-auto flex items-center justify-between">
            ...
            <button
              type="submit"
              className="h-10 sm:h-11 px-6 sm:px-8 rounded-md bg-red-600 hover:bg-red-700 text-white text-sm font-extrabold shadow-md shadow-red-600/25 transition-all cursor-pointer active:scale-95"
            >
              Confirm & Mark Lost
            </button>
          </div>
