...
export function CustomersDealersPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-strong p-4 sm:p-8 rounded-lg border border-gray-200 dark:border-[#2d302d] flex flex-col gap-4 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="flex items-center gap-2 w-full sm:w-52 px-3 py-2.5 rounded-md border border-gray-300 dark:border-[#374137] bg-white dark:bg-[#252825]">
