                    ...
                    <td className="text-right">
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          className="px-3 py-1 bg-gray-100 dark:bg-[#252825] hover:bg-gray-200 dark:hover:bg-[#2d302d] text-[#3a3b39] dark:text-gray-200 text-xs font-bold rounded-md transition-colors cursor-pointer"
                        >
                          Edit
                        </button>
                        <button
