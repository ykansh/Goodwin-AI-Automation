              ...
              {isLoading ? (
                ...
                <>
                  ...
                  {filteredLeaves.length === 0 && (
                    <tr>
                      <td colSpan={5} className="p-5 text-center text-gray-500 font-bold">No leave requests found.</td>
                    </tr>
                  )}
                </>
              )}
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg w-full max-w-md overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800">
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                <button type="submit" className="px-5 py-2.5 text-sm font-bold bg-[#00a631] text-white rounded-md hover:shadow-lg hover:shadow-[#00a631]/30 transition-all">Submit</button>
              </div>
            </form>
          </div>
        </div>
